<?php
	...
	$sql = "SELECT * FROM lecturer WHERE national_id_number != '$userName'";
...
<body>
    ...
    <div class="container">
        ...
        <!-- Marketing Icons Section -->
         <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Contact a Lecturer
                </h1>
                <ol class="breadcrumb">
                    <li><a href="../page.php">Home</a>
                    </li>
                    <li class="active">Contact a Lecturer</li>
                </ol>
            </div>
        </div>
				<?php
					...
					while($row = mysqli_fetch_row($result)){
					echo "<tr>";
					echo "<td width='250'>$row[1] $row[4]</td><td><button class='btn btn-primary' type='submit' name='receiver' value=$row[0]>Message</button></td>";
				}

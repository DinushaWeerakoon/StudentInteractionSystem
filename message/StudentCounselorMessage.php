<?php
	...
	setcookie("receiverType","studentCounselor");
	$userName = $_COOKIE["userName"];
	
	
	$sql = "SELECT * FROM studentCounselor WHERE national_id_number !='$userName' ";
	$result = mysqli_query($connect,$sql) or die(mysqli_error($connect));
	/*echo "<table width='60%'><form action='messageAction.php' method='post'>";
	while($row = mysqli_fetch_row($result)){
		echo "<tr>";
		echo "<td> $row[4]</td><td><button type='submit' name='receiver' value=$row[4]>Message</button></td>";
	}
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="../pages/page">Student Interaction System</a>
            </div>
        ...
        <div class="row">
            <div class="col-lg-12">
				...
				<?php
					...
					while($row = mysqli_fetch_row($result)){
					echo "<tr>";
					echo "<td> $row[1] $row[4]</td><td><button class='btn btn-primary' type='submit' name='receiver' value=$row[0]>Message</button></td>";
					}

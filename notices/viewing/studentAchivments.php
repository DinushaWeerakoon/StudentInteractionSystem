<?php
	...
	$query = mysqli_query($connect,"SELECT userID,content,date,title,id FROM notices Where permit = 1 and subject = 'Student Achievements' order by date DESC") or die (mysqli_error($connect));
	echo "<h1>Student Achievements</h1>";

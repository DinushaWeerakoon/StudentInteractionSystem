<?php
	...
	$query = mysqli_query($connect,"SELECT userID,content,date,title,id FROM notices Where permit = 1 and subject = 'Communication Platform' order by date DESC") or die (mysqli_error($connect));
	echo "<h1>Communication Platform</h1>";

...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header"> View a Student Counselor Profile
                </h1>
				<ol class="breadcrumb">
				...
				<?php
					...
					while($row = mysqli_fetch_row($result)){
					echo "<tr>";
					echo "<td> $row[4]</td><td><button class='btn btn-primary' type='submit' name='username' value=$row[0]>View</button></td>";
					}

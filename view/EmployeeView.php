<?php
	...
	$sql = "SELECT * FROM employer WHERE national_id_number != '$userName'";
	$result = mysqli_query($connect,$sql) or die("ERROR IN QUERY");
	/*echo "<table width='60%'><form action='messageAction.php' method='post'>";
	while($row = mysqli_fetch_row($result)){
		echo "<tr>";
		echo "<td> $row[0]</td><td><button type='submit' name='receiver' value=$row[1]>Message</button></td>";
	}
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="../pages/Administrator.php">Student Interaction System</a>
            </div>
            <!-- Collect the nav links, forms, and other content for toggling -->
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    <li>
                        <a href="../pages/Administrator.php">Home</a>
                    </li>
        ...
        <div class="row">
            <div class="col-lg-12">
				...
				<?php
					...
					while($row = mysqli_fetch_row($result)){
					echo "<tr>";
					echo "<td> $row[0]</td><td><button class='btn btn-primary' type='submit' name='username' value=$row[1]>View</button></td>";
				}

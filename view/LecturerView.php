...
<body>
    ...
    <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header"> View a Lecturer Profile
                </h1>
                <ol class="breadcrumb">
        ...
        <!-- Marketing Icons Section -->
				...
				<?php
					...
					while($row = mysqli_fetch_row($result)){
					   echo "<tr>";
					   echo "<td width='250'> $row[1] $row[4]</td><td><button class='btn btn-primary' type='submit' name='username' value=$row[0]>View</button></td></tr>";

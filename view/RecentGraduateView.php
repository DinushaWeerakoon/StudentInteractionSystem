<?php
	...
	setcookie("receiverType","recentgraduate");
	$userName = $_COOKIE["userName"];
	$sql = "SELECT * FROM recentgraduate WHERE national_id_number != '$userName'";
	$result = mysqli_query($connect,$sql) or die("ERROR IN QUERY");
	/*echo "<table width='60%'><form action='messageAction.php' method='post'>";
	while($row = mysqli_fetch_row($result)){
		echo "<tr>";
		echo "<td> $row[3]</td><td><button type='submit' name='receiver' value=$row[0]>Message</button></td>";
	}
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">
                    View a Recent Graduate Profile
                </h1>
				</div>
				...
				<?php
					...
					while($row = mysqli_fetch_row($result)){
					echo "<tr>";
					echo "<td> $row[3]</td><td><button class='btn btn-primary type='submit' name='username' value=$row[0]>View</button></td>";
					}

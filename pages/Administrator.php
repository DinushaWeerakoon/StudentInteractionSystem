<?php
	...
	//echo "<ul>";
	/*if($r[0] == '0'){
		echo "<li><font color='red'>No New</font>  Messages</li>";
	}
	else{
		echo "<li><a href='../function_pages/viewMessages.php'>Messages <font color='red'>'$r[0]'</font></a></li>";
	}*/
?>
<html lang="en">
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="Administrator.php">Student Interaction System</a>
            </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
				...
				<li>Add new Profile<ul><li> <a href='admin/add_undergraduate.php'>Undergraduate</a></li>
				<li><a href='admin/add_other_users.php'>Other users</a></ul></li>
				
				<li>Edit profile<ul><li><a href='Administrator.php'>Edit a Undergraduate Profile</a></li></ul></li>
				...
				<li><a href='../forum/forum.php'>Forum Chatting</a></li>
				
				<li><a href ='../notices/publishNotices.php'>Publish Notices</a></li>
            </div>
